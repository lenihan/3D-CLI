...
namespace DotNet3d
{
    public class Matrix
    {
        // Storing Matrix in row major: mXY. For example, m23 is the second row, column 3
        ...
        {
            Trace.Assert(array.Length == 16 || array.Length == 9);
            ...
            {
                M11 = array[0]; M12 = array[1]; M13 = array[2]; M14 = 0;
                M21 = array[3]; M22 = array[4]; M23 = array[5]; M24 = 0;
                M31 = array[6]; M32 = array[7]; M33 = array[8]; M34 = 0;
                M41 =        0; M42 =        0; M43 =        0; M44 = 1;
            }
            else
            {
                Trace.Assert(false); // invalid array size
            }
        }
